...
export default function ForgotPasswordPage() {
    ...
    return (
        <AuthLayout
            imageSrc="https://images.unsplash.com/photo-1600573472591-ee6981cf35b6?q=80&w=1500&auto=format&fit=crop"
            quote="&quot;Nghệ thuật của sự chờ đợi&quot;"
            quoteSub="Hãy để chúng tôi giúp bạn tìm lại kết nối."
            backLink="/auth/login"
