...
import { login, googleLogin, facebookLogin, selectAuthLoading } from '../../store/slices/authSlice';
            ...
            <div className="hidden lg:block lg:w-1/2 relative bg-[#faf7f4]">
                ...
                <div className="absolute bottom-12 left-12 right-12 text-white">
                    <h2 className="text-[36px] font-display mb-4 leading-[1.2]">
                        "Linh hồn của đất, tinh hoa của lửa"
                    </h2>
                    <p className="text-[15px] font-light opacity-90 max-w-[400px]">
                        Mỗi sản phẩm gốm là một câu chuyện được kể bằng sự tĩnh lặng và đôi bàn tay khéo léo.
                    </p>
                </div>
            </div>
