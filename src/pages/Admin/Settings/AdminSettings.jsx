...
} from '@/hooks/queries/admin/useAdminSettings';
...
export default function AdminSettings() {
    ...
    const { data: qSiteSettings, isLoading: loadingSite } =
        useAdminSiteSettings();
    ...
    const { data: qEmailTemplates, isLoading: loadingEmails } =
        useAdminEmailTemplates();

    const loading =
        loadingSite || loadingHome || loadingTimeline || loadingEmails;
    ...
    const saveSiteSettings = async () => {
        try {
            const payload = siteSettings.map((s) => ({
                key: s.key,
                value: s.value,
            }));
    ...
    const handleHomeBlockToggleVisibility = async (block) => {
        ...
        setHomeBlocks((prev) =>
            prev.map((b) => (b.blockKey === block.blockKey ? updatedBlock : b)),
        );
        try {
            ...
            toast.success(
                `Đã cập nhật trạng thái hiển thị của block ${block.displayName}`,
            );
        } catch (err) {
            toast.error(`Lỗi khi cập nhật trạng thái hiển thị`);
            // Revert state on error
            setHomeBlocks((prev) =>
                prev.map((b) => (b.blockKey === block.blockKey ? block : b)),
            );
        }
    };
            ...
            prev.map((b) => {
                if (b.blockKey === blockKey) {
                    ...
                    if (field === null) {
                        ...
                        // For object arrays
                        const currentItem =
                            typeof data[arrayField][index] === 'string'
                                ? { image: data[arrayField][index] }
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                    Quản lý cấu hình website, trang chủ và email.
                </p>
            </div>
                    ...
                    <>
                        ...
                        {activeTab === 'store' && (
                            <div className="space-y-8 max-w-4xl">
                                ...
                                {[
                                    ...new Set(
                                        siteSettings.map((s) => s.group),
                                    ),
                                ].map((group) => {
                                    const groupSettings = siteSettings.filter(
                                        (s) => s.group === group,
                                    );
                                                                ...
                                                                {isImage ? (
                                                                    <div className="flex gap-2 items-start">
                                                                        <div className="flex-1 space-y-2">
                                                                            ...
                                                                            />
                                                                            <label
                                                                                className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-md cursor-pointer transition-colors ${uploadingField === setting.key ? 'bg-gray-200 text-gray-500' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                                                                            >
                                                                                <FiUpload />{' '}
                                                                                {uploadingField ===
                                                                                setting.key
                                                    ...
                                                    <div className="flex justify-between items-center">
                                                        ...
                                                        <div className="flex items-center gap-4">
                                                            <label className="flex items-center gap-2 cursor-pointer group">
                                                                ...
                                                                <div
                                                                    className={`w-10 h-5 flex items-center bg-gray-300 rounded-full p-1 transition-colors duration-300 ease-in-out ${block.isVisible ? 'bg-green-500' : ''}`}
                                                                >
                                                                    <div
                                                                        ...
                                                                        onClick={(
                                                                            ...
                                                                            e.preventDefault();
                                                                            handleHomeBlockToggleVisibility(
                                                                                block,
                                                                            );
                                                                        }}
                                                                    ></div>
                                                        ...
                                                        {data.image !==
                                                            ...
                                                            <div className="md:col-span-2 mt-4 pt-4 border-t">
                                                                ...
                                                                <div className="flex gap-4 items-start">
                                                                    <div
                                                                        className="w-40 h-24 rounded-lg overflow-hidden border border-gray-200 bg-gray-50 flex-shrink-0 cursor-pointer relative group"
                                                                        onClick={() =>
                                                                            data.image &&
                                                                            setPreviewImage(
                                                                                data.image,
                                                                    ...
                                                                    <div className="flex-1 space-y-3">
                                                                        ...
                                                                        <div className="relative inline-block">
                                                                            <button
                                                                                type="button"
                                                                                className={`flex items-center gap-2 text-sm px-4 py-2 rounded-md transition-colors ${uploadingField === `${block.blockKey}_image` ? 'bg-gray-100 text-gray-500 cursor-wait' : 'bg-primary-50 text-primary-600 hover:bg-primary-100'}`}
                                                                            >
                                                                                {uploadingField ===
                                                                                `${block.blockKey}_image` ? (
                        ...
                        {activeTab === 'contact' && (
                            <div className="space-y-6 animate-fade-in">
                                {homeBlocks
                                    .filter((b) =>
                                        b.blockKey.startsWith('contact_'),
                                    )
                                    .sort((a, b) => a.sortOrder - b.sortOrder)
                                    .map((block) => {
                                        const data = JSON.parse(
                        ...
                        {(activeTab === 'home' || activeTab === 'about') && (
                            <div className="space-y-6">
                                {homeBlocks
                                    .filter((b) =>
                                        activeTab === 'home'
                                            ? !b.blockKey.startsWith(
                                                  'about_',
                                              ) && b.blockKey !== 'brand_story'
                                            : b.blockKey.startsWith('about_') ||
                                              b.blockKey === 'brand_story',
                                    )
                                    .map((block) => {
                                        const data = JSON.parse(
                                                    ...
                                                    <div className="space-y-6">
                                                        <div className="flex justify-between items-center bg-gray-50 px-4 py-2 rounded-lg border">
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex items-center gap-1 text-sm bg-primary-50 text-primary-600 px-3 py-1.5 rounded-md hover:bg-primary-100"
                                                            >
                                                                <FiPlus
                                                                    size={14}
                                                                />{' '}
                                                            ...
                                                            data.slides.map(
                                                                (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <h4 className="font-medium text-sm mb-4 border-b pb-2">
                                                                            Slide{' '}
                                                                            {index +
                                                                                1}
                                                                        </h4>
                                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                                            <div className="md:col-span-2 flex gap-4 items-start">
                                                                                <div className="flex-1 space-y-2">
                                                                                    ...
                                                                                    />
                                                                                    <label
                                                                                        className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-md cursor-pointer transition-colors ${uploadingField === `hero-slide-${index}` ? 'bg-gray-200 text-gray-500' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
                                                                                    >
                                                                                        <FiUpload />{' '}
                                                                                        {uploadingField ===
                                                                                        `hero-slide-${index}`
                                                                    ...
                                                                    (
                                                                        ...
                                                                        return (
                                                                            <div
                                                                                ...
                                                                                className="flex flex-col gap-2 border p-3 rounded bg-gray-50 relative"
                                                                            >
                                                                                <button
                                                                                    type="button"
                                                                                    onClick={() =>
                                                                                    ...
                                                                                    <div className="flex-1 space-y-2">
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                className="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:border-[#b5624a] text-sm"
                                                                                                placeholder="VD: /shop hoặc https://..."
                                                                                            />
                                                                                        </div>
                                                                                    </div>
                                                                                    {imgSrc && (
                                                                                        <img
                                                                                            ...
                                                                                            alt="preview"
                                                                                            className="w-20 h-20 object-cover rounded shadow-sm cursor-pointer border"
                                                                                            onClick={() =>
                                                                                                setPreviewImage(
                                                                                                    imgSrc,
                                                                                                )
                                                            ...
                                                            {data.stats?.map(
                                                                (stat, idx) => (
                                                                    <div
                                                                        ...
                                                                        className="flex gap-2 items-start border p-3 rounded bg-gray-50 relative"
                                                                    >
                                                                        <button
                                                                            type="button"
                                                                            onClick={() =>
                                                                        ...
                                                                        <div className="flex-1 space-y-2">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                placeholder="Nhãn (VD: Năm Thành Lập)"
                                                                                className="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:border-[#b5624a] text-sm"
                                                                            />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            {data.values?.map(
                                                                (val, idx) => (
                                                                    <div
                                                                        ...
                                                                        className="flex gap-4 items-start border p-4 rounded bg-gray-50 relative"
                                                                    >
                                                                        <button
                                                                            type="button"
                                                                            onClick={() =>
                                                                    ...
                                                                    key ===
                                                                        ...
                                                                        <div className="flex gap-2 items-start">
                                                                            <div className="flex-1 space-y-2">
                                                                                ...
                                                                                />
                                                                                <label
                                                                                    className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-md cursor-pointer transition-colors ${uploadingField === `${block.blockKey}-${key}` ? 'bg-gray-200 text-gray-500' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                                                                                >
                                                                                    <FiUpload />{' '}
                                                                                    {uploadingField ===
                                                                                    `${block.blockKey}-${key}`
                                    ...
                                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 mb-6">
                                            ...
                                            <div className="md:col-span-2">
                                                ...
                                                <div className="flex gap-4 items-center">
                                                    ...
                                                    <div className="flex-1 space-y-2">
                                                        ...
                                                        />
                                                        <label
                                                            className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-md cursor-pointer transition-colors ${uploadingField === 'timeline-new' ? 'bg-gray-200 text-gray-500' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                                                        >
                                                            <FiUpload />{' '}
                                                            {uploadingField ===
                                                            'timeline-new'
                                        ...
                                        <div className="flex justify-end gap-2">
                                            ...
                                            <button
                                                ...
                                                className="px-4 py-2 text-sm font-medium text-white bg-[#b5624a] hover:bg-[#8e4a36] rounded-lg flex items-center gap-2"
                                            >
                                ...
                                {timeline.map((entry) => (
                                    ...
                                    >
                                        <div className="w-full md:w-32 flex-shrink-0">
                                            <div className="text-2xl font-display font-bold text-[#b5624a]">
                                                {entry.year}
                                            </div>
                                            <img
                                                src={
                            ...
                            <div className="flex flex-col lg:flex-row gap-8 items-start">
                                ...
                                <div className="flex-1 space-y-6 w-full lg:max-w-3xl">
                                    <p className="text-sm text-gray-500 mb-6">
                                        Chỉnh sửa nội dung các mẫu email tự động
                                        được gửi từ hệ thống.
                                    </p>
                                    {emails.map((email) => {
                                        const usedSystemVariables = siteSettings
                                            .map((s) => {
                                                if (!s.key) return null;
                                                const parts = s.key.split('_');
                                                const pascalCaseKey = parts
                                                    .map(
                                                        (p) =>
                                                            p
                                                                .charAt(0)
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="bg-gray-50 border border-gray-200 rounded-md p-3 mt-2">
                                                                    ...
                                                                    .map(
                                                                        (p) => (
                                                                            <code
                                                                                ...
                                                                                className="bg-white border border-gray-200 px-1.5 py-0.5 rounded mr-1.5 mb-1.5 inline-block"
                                                                            >
                                                                                {
                                                                                    p
                                                                                }
                                                            ...
                                                            {usedSystemVariables.length >
                                                            0 ? (
                                                                <p className="text-xs text-gray-500 mb-0">
                                                                    {usedSystemVariables.map(
                                                                        (p) => (
                                                                            <code
                                                                                key={
                                                                                    p
                                                                                }
                                                                                className="bg-blue-50 text-blue-700 border border-blue-200 px-1.5 py-0.5 rounded mr-1.5 mb-1.5 inline-block"
                                                                            >
                                                                                {
                                                                                    p
                                                                                }
                                ...
                                <div className="w-full lg:w-80 sticky top-4 flex-shrink-0">
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 max-h-[85vh] overflow-y-auto shadow-sm">
                                        ...
                                        <p className="text-[11px] text-blue-800 mb-4 leading-relaxed">
                                            Các biến này lấy tự động từ tab{' '}
                                            <strong>Cấu hình chung</strong>. Bạn
                                            có thể sử dụng (copy/paste) chúng
                                            vào bất kỳ mẫu email nào ở cột bên
                                            trái.
                                        </p>
                                        <div className="flex flex-col gap-3">
                                            {siteSettings.map((s) => {
                                                ...
                                                return (
                                                    <div
                                                        key={s.key}
                                                        className="flex flex-col border-b border-blue-100/50 pb-2 last:border-0 last:pb-0"
                                                    >
                                                        <code className="text-[11px] font-bold text-blue-900 bg-white px-1.5 py-0.5 rounded border border-blue-200 w-fit mb-1">
                                                            {placeholder}
                                                        </code>
            ...
            {previewEmailTemplate !== null && (
                <div
                    className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 p-4 sm:p-8 backdrop-blur-sm"
                    onClick={() => setPreviewEmailTemplate(null)}
                >
                    <div
                        className="bg-white rounded-xl shadow-2xl w-full max-w-5xl h-full max-h-[90vh] flex flex-col overflow-hidden"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="flex justify-between items-center px-6 py-4 border-b bg-gray-50">
                            <h3 className="font-semibold text-gray-800">
                                Xem trước Giao diện Email
                            </h3>
                            <button
