    ...
    return (
        <nav
            className="sticky top-0 z-[100] bg-white border-b border-gray-200
                        px-20 flex items-center justify-between h-[90px] backdrop-blur-sm relative"
        >
            {/* ── Left: Nav Links ── */}
            ...
            >
                ...
                />
                <span className="font-['Charmonman'] font-semibold text-[12px] tracking-[3px] text-[#5c3a21] mb-2">
                    Champa Clay
                </span>
            </div>
            ...
            <div className="flex gap-5 items-center">
                    ...
                    {isSearchOpen && (
                        <div className="mr-3">
                            ...
                            >
                                ...
                                />
                                {isSearching && (
                                    <span className="absolute right-0 top-1 w-3 h-3 border-2 border-gray-300 border-t-[#5c3a21] rounded-full animate-spin"></span>
                                )}
                            </form>
                                            ...
                                            {searchResults.map((product) => (
                                                ...
                                                >
                                                    <img
                                                        ...
                                                        alt={product.name}
                                                        className="w-14 h-14 object-cover rounded-md flex-shrink-0 bg-gray-100 mix-blend-multiply"
                                                    />
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1">
                                                            <span className="text-[13px] font-bold text-[#b5624a]">
                                                                {formatCurrency(
                                                                    product.price,
                                                                )}
                                                            </span>
                ...
                >
                    ...
                    {cartCount > 0 && (
                        <span
                            className="absolute -top-2 -right-2 w-[18px] h-[18px] rounded-full
